...
void usage(){
    ...
    printf("Show all players you can invite  input: 2\n");
    printf("Invite player\t\t\t input: 3 Your_name Other's_name\n");
...
int main(int argc, char *argv[])
{
    ...
    while(1){
	    ...
	    else printf("cannot put on the same place, try again\n");
        }
